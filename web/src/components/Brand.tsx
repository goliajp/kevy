...
//
// Byte-identical to the file of the same name in rust-tiktoken: the two
// Golia Lab pages are one publication and their chrome should not differ.
// Copied rather than shared, because a package for three SVG paths is a
// dependency the zero-dependency rule would have to make an exception for.
//
