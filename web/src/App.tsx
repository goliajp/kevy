...
const PERF: { op: string; kevy: string; valkey: string; ratio: string }[] = [
  { op: 'GET', kevy: '7.40 M', valkey: '3.09 M', ratio: '2.40×' },
  { op: 'SET', kevy: '6.31 M', valkey: '1.69 M', ratio: '3.72×' },
  { op: 'INCR', kevy: '6.29 M', valkey: '2.22 M', ratio: '2.83×' },
  { op: 'HSET', kevy: '4.51 M', valkey: '1.86 M', ratio: '2.42×' },
]
