...
50 rules. **10 locked by a gate**, **9 counted here**, **31 needing a reader**.
...
| `mod/mod-rs-assembles-only` | 全 | **COUNTED** | 32 — assembly points carrying logic, 355 functions between them |
...
| `unsafe/forbid-op-in-unsafe-fn` | 边石 | **LOCKED** | declared once at the workspace |
