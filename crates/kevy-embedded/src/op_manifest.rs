...
pub(crate) const ESTORE_OPS: &[&str] = &[
    ...
    "HKEYS", "HLEN", "HMGET", "HSCAN", "HSET", "HSETNX", "HEXPIRE", "HPEXPIRE", "HPEXPIREAT", "HTTL", "HPTTL", "HPERSIST", "HVALS",
    // lists
    ...
    "ZINTERSTORE", "ZPOPMIN", "ZPOPMIN.BELOW", "ZRANGE",
    "ZRANGEBYSCORE", "ZRANK", "ZREM", "ZREMRANGEBYRANK",
    "ZREMRANGEBYSCORE", "ZREVRANGE", "ZREVRANGEBYSCORE", "ZSCAN",
    "ZSCORE", "ZUNIONSTORE",
    // keyspace
    "COPY", "DBSIZE", "FEED.READ", "FEED.SHARDS", "FEED.TAIL", "IDX.ADVISE", "IDX.COUNT", "IDX.CREATE", "IDX.DROP", "IDX.LIST", "IDX.QUERY", "PREFIX.DIGEST", "TABLE.DECLARE", "TABLE.ENSURE", "TABLE.REPLACE", "TABLE.DROP", "TABLE.LIST", "TABLE.VERIFY", "VIEW.CREATE", "VIEW.DROP", "VIEW.LIST", "VIEW.QUERY", "PREFIX.STATS", "DEL", "EXISTS", "EXPIRE", "EXPIREAT",
