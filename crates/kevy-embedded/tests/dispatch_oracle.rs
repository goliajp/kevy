...
fn cases() -> Vec<(Vec<&'static [u8]>, Cmp)> {
    ...
    vec![
        ...
        c(
            &[b"IDX.QUERY", b"noidx", b"RANGE", b"0", b"9", b"CURSOR", b"0", b"SORT", b"f", b"ASC"],
            Exact,
        ),
        ...
        c(
            &[b"TABLE.DECLARE", b"t1", b"PREFIX", b"tt:", b"PK", b"id", b"COLUMN", b"id", b"uuid"],
            Exact,
        ),
        c(
            &[b"TABLE.DECLARE", b"t1", b"PREFIX", b"tt:", b"PK", b"nope", b"COLUMN", b"id", b"str"],
            Exact,
        ),
        c(
            &[
        ...
        c(
            &[b"TABLE.DECLARE", b"t1", b"PREFIX", b"tt:", b"PK", b"id", b"COLUMN", b"id", b"str"],
            Exact,
        ),
...
fn table_surface_matches_the_real_server() {
    ...
    for _ in 0..200 {
        let r =
            server_reply(&mut sock, &mut buf, &[b"IDX.QUERY", b"user.age", b"RANGE", b"0", b"0"]);
        let r2 = server_reply(
            &mut sock,
            &mut buf,
