...
//! a signal exception (the scalar GET's wrong-type fallback), for six slots.
//! Each index below was counted out of the real headers — `reserved0` = slot
//! 0, `GetVersion` = slot 4 — and the count is identical in Zulu JDK 17
//! `include/jni.h` and Android NDK r27 `sysroot/usr/include/jni.h`:
//!
