    ...
    pub(crate) fn from_opts(o: &Opts) -> Config {
        ...
        for (flag, value) in &o.modes.cluster_flags {
            ...
            match flag.as_slice() {
                ...
                b"--cluster-master-id" => c.master_id = Some(v),
                ...
                b"--cluster-only-masters" => c.only_masters = true,
                ...
                b"--cluster-slave" => c.replica = true,
                b"--cluster-use-empty-masters" => c.use_empty_masters = true,
                b"--cluster-search-multiple-owners" => c.search_multiple_owners = true,
                b"--cluster-fix-with-unreachable-masters" => c.fix_with_unreachable_masters = true,
                _ => {}
            }
        }
        c
