...
fn duplicate_heavy_corpus_stays_connected() {
    ...
    // artifact.
    const DATA: &[u8] = &[
        0x01, 0x80, 0x08, 0x10, 0x18, 0x20, 0x28, 0xff, 0x16, 0x40, 0x48, 0x50, 0x58, 0x1c, 0x2d,
        0x06, 0x3d, 0x28, 0x29, 0x06, 0x3d, 0x28, 0x2b, 0x2e, 0x31, 0x3d, 0x85, 0x88, 0x8b, 0x2b,
        0x2e, 0x31, 0x34, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0xca, 0xcd, 0xd0, 0xd3, 0xd6,
        0xd9, 0x91, 0x94, 0x2e, 0xca, 0xcd, 0xd0, 0xd3, 0xd6, 0xd9, 0xdc, 0xdf, 0xe2, 0xe5, 0xe8,
        0xeb, 0xee,
    ];
    const DIM: usize = 4;
    fn comp(b: u8) -> f32 {
