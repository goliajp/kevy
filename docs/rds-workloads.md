...
- What you get: predictable serving latency (hydrated page p99 < 1ms,
  ...
  [designing-on-kevy](designing-on-kevy.md)), and write absorption an
  RDS cannot match at the same durability setting
...
The comparison that would favour kevy — a dataset far larger than RAM —
is not measured yet.
