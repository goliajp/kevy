...
public sealed partial class KevyClient
{
    ...
    public Task<long> HSetAsync(KevyBytes key, KevyBytes[] pairs, CancellationToken ct = default) =>
    ...
    public Task<byte[]?> HGetAsync(KevyBytes key, KevyBytes field, CancellationToken ct = default) =>
    ...
    public Task<long> HDelAsync(KevyBytes key, KevyBytes[] fields, CancellationToken ct = default) =>
    ...
    public Task<long> HLenAsync(KevyBytes key, CancellationToken ct = default) =>
    ...
    public async Task<IReadOnlyList<byte[]>> HGetAllAsync(KevyBytes key, CancellationToken ct = default) =>
    ...
    public async Task<IReadOnlyList<byte[]>> HKeysAsync(KevyBytes key, CancellationToken ct = default) =>
    ...
    public async Task<IReadOnlyList<byte[]>> HValsAsync(KevyBytes key, CancellationToken ct = default) =>
    ...
    public Task<long> LPushAsync(KevyBytes key, KevyBytes[] values, CancellationToken ct = default) =>
    ...
    public Task<long> RPushAsync(KevyBytes key, KevyBytes[] values, CancellationToken ct = default) =>
    ...
    public async Task<IReadOnlyList<byte[]>> LPopAsync(KevyBytes key, int count, CancellationToken ct = default) =>
    ...
    public async Task<IReadOnlyList<byte[]>> RPopAsync(KevyBytes key, int count, CancellationToken ct = default) =>
    ...
    public Task<long> LLenAsync(KevyBytes key, CancellationToken ct = default) =>
    ...
    public async Task<IReadOnlyList<byte[]>> LRangeAsync(KevyBytes key, long start, long stop, CancellationToken ct = default) =>
    ...
    public Task<long> SAddAsync(KevyBytes key, KevyBytes[] members, CancellationToken ct = default) =>
    ...
    public Task<long> SRemAsync(KevyBytes key, KevyBytes[] members, CancellationToken ct = default) =>
    ...
    public async Task<IReadOnlyList<byte[]>> SMembersAsync(KevyBytes key, CancellationToken ct = default) =>
    ...
    public Task<long> SCardAsync(KevyBytes key, CancellationToken ct = default) =>
    ...
    public Task<bool> SIsMemberAsync(KevyBytes key, KevyBytes member, CancellationToken ct = default) =>
    ...
    public async Task<IReadOnlyList<byte[]>> SInterAsync(KevyBytes[] keys, CancellationToken ct = default) =>
    ...
    public async Task<IReadOnlyList<byte[]>> SUnionAsync(KevyBytes[] keys, CancellationToken ct = default) =>
    ...
    public async Task<IReadOnlyList<byte[]>> SDiffAsync(KevyBytes[] keys, CancellationToken ct = default) =>
    ...
    public Task<long> ZAddAsync(KevyBytes key, ZMember[] members, CancellationToken ct = default) =>
    ...
    public Task<long> ZRemAsync(KevyBytes key, KevyBytes[] members, CancellationToken ct = default) =>
    ...
    public async Task<double?> ZScoreAsync(KevyBytes key, KevyBytes member, CancellationToken ct = default) =>
    ...
    public Task<long> ZCardAsync(KevyBytes key, CancellationToken ct = default) =>
    ...
    public async Task<IReadOnlyList<byte[]>> ZRangeAsync(KevyBytes key, long start, long stop, CancellationToken ct = default) =>
