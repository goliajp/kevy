...
PAGES["benchmarks"] = {
    ...
    "blocks": [
        ...
        },
        {
            ...
            "head": ["", "kevy 5.4.0", "Redis 8", "valkey 9.1", "Dragonfly", "vs Redis 8"],
            "rows": [
                ["GET", "7,391,182", "5,821,211", "3,288,784", "2,846,930", "*1.27×"],
                ["SET", "6,831,207", "2,577,415", "1,740,326", "1,855,128", "*2.65×"],
                ["INCR", "6,345,807", "3,334,691", "2,238,322", "2,018,528", "*1.90×"],
                ["SADD", "5,855,274", "3,760,040", "2,250,453", "1,785,213", "*1.56×"],
                ["HSET", "4,757,415", "2,948,014", "1,850,860", "1,734,250", "*1.61×"],
                ["LPUSH", "3,306,296", "2,805,078", "1,871,496", "1,491,325", "!1.18×"],
                ["ZADD", "3,299,310", "2,907,782", "1,758,659", "1,750,629", "!1.13×"],
            ],
            "note": (
