...
2) "doc:9982"</code></pre>""",
        ...
        },
        {
            ...
            "body": (
                ...
                "<code>SCAN</code> 不是游标迭代器，<code>SPOP</code> 不随机，"
                "跨 shard 的 <code>RENAME</code> 不是原子的。"
