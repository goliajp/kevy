...
PAGES["benchmarks"] = {
    ...
    "blocks": [
        ...
        },
        {
            ...
            "head": ["", "kevy 5.2.0", "Redis 8", "valkey 9.1", "Dragonfly", "vs Redis 8"],
            "rows": [
                ["GET", "7,421,434", "5,490,744", "3,059,825", "2,896,061", "*1.35×"],
                ["SET", "6,803,042", "2,519,336", "1,693,228", "1,863,375", "*2.70×"],
                ["INCR", "6,257,248", "3,275,159", "2,314,211", "2,032,917", "*1.91×"],
                ["SADD", "6,326,464", "3,663,988", "2,212,577", "1,755,908", "*1.73×"],
                ["HSET", "4,624,267", "3,002,949", "1,813,222", "1,726,330", "*1.54×"],
                ["LPUSH", "3,152,557", "2,865,516", "1,900,425", "1,476,418", "!1.10×"],
                ["ZADD", "3,131,849", "2,838,225", "1,780,257", "1,746,110", "!1.10×"],
            ],
            "note": (
