...
#   * where kevy wins by a lot, and where by almost nothing (LPUSH: 10%);
...
PAGES[""] = {
    ...
    "blocks": [
        ...
        },
        {
            ...
            "intro": (
                "RESP2 と RESP3、205 個のコマンド——redis-cli も、クライアント"
            ...
            "note": (
                "<b>LPUSH と ZADD は、10% と 18% しか上回っていません。</b>リストや"
    ...
    "blocks": [
        ...
        },
        {
            ...
            "body": [
                ...
                "205 個のコマンドに応答します。既存のライブラリの接続先を変えるだけで、"
        ...
        },
        {
            ...
            "items": [
                ...
                },
                {
                    ...
                    "body": "同じマシンで Redis 8.10.1 に対して、GET は 1.26 倍、SET は 2.68 倍、INCR は 1.95 倍です。ただし、当てにする前に表の全体を読んでください——LPUSH と ZADD は 10% と 18% しか上回っておらず、リストやソート済みセットがホットパスなら、これは移る理由になりません。",
                },
                {
            ...
            "items": [
                {
                    ...
                    "a": "ワイヤの上では、なります。RESP2 と RESP3、205 個のコマンドに対応し、クライアントライブラリは違いに気づきません。挙動もおおむね同じですが、その例外こそが要点です。シャードをまたぐ <code>RENAME</code> は原子的ではありません——複数キーの書き込みは shard 単位でのみ原子的です。また SCAN のカーソルは発行したサーバーでのみ有効で、これは Redis Cluster のノード単位の性質と同じです。<a href=\"~/docs/commands/\">205 個すべてのコマンドに、本当の差異と本当のコストを併記してあります</a>。Redis の文書から書き写したものではなく、実装から読み出したものです。",
                },
                {
...
-> (integer) 1""",
        ...
        },
        {
            ...
            "items": [
                ...
                {"kicker": "リファレンス", "title": "全コマンド", "body": "205 個のコマンド。それぞれの本当のコストと、Redis との差異つき。", "go": "調べる", "href": "docs/commands/"},
            ],
        },
    ],
}
...
PAGES["benchmarks"] = {
    "title": "ベンチマーク — kevy",
    "desc": "1 台のマシンでの kevy 6.2.2 と Redis 8.10.1、valkey 9.1.2、Dragonfly 1.40.2 の比較——kevy がかろうじて上回っているだけのコマンドも含めて。",
    ...
    "blocks": [
        ...
        },
        {
            ...
            "head": ["", "kevy 6.2.2", "Redis 8.10.1", "valkey 9.1.2", "Dragonfly 1.40.2", "Redis 8.10.1 比"],
            "rows": [
            ...
            "note": (
                "<b>LPUSH は Redis 8.10.1 より 10%、ZADD は 18% 速いだけです。</b>この差"
