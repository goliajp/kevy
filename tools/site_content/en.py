...
PAGES["benchmarks"] = {
    ...
    "blocks": [
        ...
        },
        {
            ...
            "head": ["", "kevy 5.3.0", "Redis 8", "valkey 9.1", "Dragonfly", "vs Redis 8"],
            "rows": [
                ["GET", "7,506,349", "5,822,141", "3,046,095", "2,885,997", "*1.29×"],
                ["SET", "6,876,300", "2,609,199", "1,679,993", "1,996,727", "*2.64×"],
                ["INCR", "6,549,550", "3,359,132", "2,226,254", "2,079,269", "*1.95×"],
                ["SADD", "5,746,793", "3,770,936", "2,265,300", "1,762,696", "*1.52×"],
                ["HSET", "4,105,521", "2,940,319", "1,886,049", "1,762,757", "*1.40×"],
                ["LPUSH", "3,087,402", "2,850,640", "1,879,305", "1,456,966", "!1.08×"],
                ["ZADD", "3,007,920", "2,865,099", "1,807,314", "1,754,359", "!1.05×"],
            ],
            "note": (
