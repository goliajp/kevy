...
PAGES["benchmarks"] = {
    ...
    "blocks": [
        ...
        },
        {
            ...
            "head": ["", "kevy 5.1.0", "Redis 8", "valkey 9.1", "Dragonfly", "vs Redis 8"],
            "rows": [
                ["GET", "7,371,451", "5,703,669", "3,287,418", "2,800,249", "*1.29×"],
                ["SET", "6,968,430", "2,523,162", "1,698,736", "1,851,895", "*2.76×"],
                ["INCR", "5,905,021", "3,392,895", "2,242,787", "1,905,756", "*1.74×"],
                ["SADD", "5,194,985", "3,730,922", "2,409,047", "1,697,913", "*1.39×"],
                ["HSET", "4,494,466", "3,069,040", "1,994,103", "1,834,717", "*1.46×"],
                ["LPUSH", "3,090,006", "2,844,889", "1,867,039", "1,451,926", "!1.09×"],
                ["ZADD", "3,064,599", "2,833,020", "1,913,900", "1,734,808", "!1.08×"],
            ],
            "note": (
