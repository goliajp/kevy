...
SECTIONS = [
    ...
    ("deploy", {"en": "Running it", "zh": "运行", "ja": "運用"},
     ["upgrading-5.0-to-5.1", "upgrading-4-to-5", "replication", "availability", "cluster", "tiering", "accept-shards", "alloc", "uds", "async"]),
...
BLURB = {
    "en": {
        ...
        "alloc": "The opt-in allocator: ~10% smaller RSS, priced honestly.",
    ...
    "ja": {
        ...
        "alloc": "オプトインのアロケータ —— RSS 約 10% 減、代価は正直に値札どおり。",
